          ...
          <ul>
            ...
            <li class="user-profile">
              <div class="btn-group">
                ...
                >
                <div class="">
                  <img src="{{asset('/images/user.png')}}" height="42px" />
                </div>
                    ...
                    <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="#">
                          <span>
                            <svg
                              ...
                              width="14.602"
                              height="14.636"
                              viewBox="0 0 14.602 14.636"
                              >
                              <g
                                id="Setting_icon"
                                data-name="Setting icon"
                                transform="translate(-215.957 -39.599)"
                                >
                                <path
                                  id="Path_387"
                                  data-name="Path 387"
                                  ...
                                  transform="translate(213.707 37.349)"
                                  fill="none"
                                  stroke="#181c32"
                                  ...
                                  cy="1.689"
                                  r="1.689"
                                  transform="translate(221.57 45.415)"
                                  fill="none"
                                  stroke="#181c32"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                        ...
                        <li>
                          ...
                          <!-- Logout Button -->
                          <li>
                            <form class="btn eLogut_btn" method="POST" action="{{ route('logout') }}">
                              @csrf
                              <span>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
