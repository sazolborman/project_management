    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="updateCompanyModalLabel">Update Company</h1>
                      ...
                      <form id="add_company_form_1">
                        ...
                        <div class="fpb-7">
                          ...
                          <select
                            ...
                            id="update_client_id" name="update_client_id"
                            >
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary update_company">Update</button>
        </div>
      </div>
    </div>
